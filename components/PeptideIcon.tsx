...
const MAP: { match: string[]; meta: IconMeta }[] = [
  { match: ["bpc-157", "bpc157"], meta: { icon: HeartPulse, color: "#34d399", glow: "rgba(52,211,153,0.18)" } },
  { match: ["ghk-cu", "ghk"], meta: { icon: Sparkles, color: "#a78bfa", glow: "rgba(167,139,250,0.18)" } },
  { match: ["nad+", "nad"], meta: { icon: Zap, color: "#e0bd6e", glow: "rgba(224,189,110,0.2)" } },
  { match: ["pt-141", "pt141"], meta: { icon: Flame, color: "#f87171", glow: "rgba(248,113,113,0.18)" } },
  { match: ["vip nasal", "vip"], meta: { icon: Wind, color: "#2dd4bf", glow: "rgba(45,212,191,0.18)" } },
  { match: ["mk-677", "ibutamoren", "mk677"], meta: { icon: Moon, color: "#818cf8", glow: "rgba(129,140,248,0.18)" } },
  { match: ["semaglutide", "sema"], meta: { icon: Droplet, color: "#60a5fa", glow: "rgba(96,165,250,0.18)" } },
  ...
  { match: ["testosterone", "hormone", "cypionate"], meta: { icon: Dumbbell, color: "#e93d3d", glow: "rgba(233,61,61,0.2)" } },
  { match: ["thyroid"], meta: { icon: Activity, color: "#2dd4bf", glow: "rgba(45,212,191,0.18)" } },
  { match: ["nutrition"], meta: { icon: Leaf, color: "#4ade80", glow: "rgba(74,222,128,0.18)" } },
  { match: ["body scan", "scan"], meta: { icon: Scale, color: "#94a1a6", glow: "rgba(148,161,166,0.18)" } },
  ...
  { match: ["iv supplies", "iv ", "infusion"], meta: { icon: Droplet, color: "#7dd3fc", glow: "rgba(125,211,252,0.16)" } },
];

const FALLBACK: IconMeta = { icon: Dna, color: "#e93d3d", glow: "rgba(233,61,61,0.18)" };
