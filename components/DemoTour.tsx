...
export function DemoTour() {
  ...
  if (step < 0) {
    return (
      <button
        onClick={start}
        className="fixed bottom-20 left-4 z-[90] inline-flex items-center gap-2 rounded-full border border-gold-400/30 bg-ink-850/95 px-3.5 py-2 text-xs font-medium text-gold-200 shadow-glow backdrop-blur transition-colors hover:bg-ink-800 lg:bottom-6"
      >
