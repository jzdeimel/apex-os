...
const OVERRIDES: Record<string, Record<string, number>> = {
  ...
  "c-006": { tsh: 5.8, ft3: 2.4, ft4: 0.9, rt3: 19, vitd: 34, b12: 380 },
  "c-007": { igf1: 158, hct: 46 },
  "c-008": { a1c: 6.1, glucose: 112, insulin: 16.5, trig: 158, vitd: 36 },
  ...
  "c-016": { tsh: 5.2, ft3: 2.5, ft4: 0.95, rt3: 18, vitd: 37 },
