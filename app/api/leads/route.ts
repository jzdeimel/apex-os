 ...
 * `read:business-metrics` — an OWNER-only capability, deliberately distinct from
 * `read:financial`, which coaches hold so they can discuss a member's own plan
 * costs. Funnel performance across the business is not that.
 */
