...
export default function ExplorePage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* ------------------------------------------------------------------ */}
      <FadeIn>
        <div className="rounded-3xl border border-gold-400/25 bg-gradient-to-br from-gold-400/12 via-gold-400/4 to-transparent px-5 py-7 sm:px-8 sm:py-9">
          <p className="label-eyebrow">Where you are today</p>
          <h2 className="mt-3 max-w-2xl font-display text-xl font-semibold leading-snug text-ink-50 sm:text-2xl">
            {client.firstName}, you&rsquo;re on the {data.trackLabel.toLowerCase()} track
            {membership ? ` with an ${membership.tier} membership` : ""}.
          </h2>
          <p className="mt-3 max-w-prose text-[14px] leading-relaxed text-ink-300">
          ...
          <Card>
            <CardContent className="p-5 sm:p-6">
              ...
              <ul className="mt-3 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-2">
                {benefits.map((b) => (
                  <li key={b} className="flex items-start gap-2 text-[13px] leading-relaxed text-ink-300">
      ...
      <FadeIn>
        <Card>
          <CardContent className="p-5 sm:p-6">
            ...
            <p className="mt-2 max-w-prose text-[13px] leading-relaxed text-ink-300">
          ...
          <Card>
            <CardContent className="p-5 sm:p-6">
              <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                <p className="font-display text-base font-semibold text-ink-50">{upgrade.to}</p>
                <p className="stat-mono text-sm text-ink-300">
                  +{dollars(upgrade.monthlyDifference * 100)}/mo
                </p>
              </div>
              <ul className="mt-4 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-2">
                {upgrade.adds.map((a) => (
                  <li key={a} className="flex items-start gap-2 text-[13px] leading-relaxed text-ink-300">
        ...
        <CardContent className="p-5 sm:p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <Link
              ...
              className="focus-ring inline-flex items-center gap-1.5 rounded-lg text-[13px] font-medium text-gold-300 hover:text-gold-200"
            >
