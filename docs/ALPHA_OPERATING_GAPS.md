...
| Inventory, dispensing and fulfillment | Authoritative lot/expiry receiving, immutable stock movements, cycle-count reconciliation, waste, atomic inter-clinic transfer, patient dispensing and recall-to-affected-patient traceability now exist. Expired/recalled stock cannot leave, negative stock is rejected, and controlled dispensing requires matching prescription/DEA/PDMP evidence. MedSource/UPS transport, cold-chain logs, reorder policy, shipment acknowledgement and daily vendor reconciliation are not accepted. | Run clinic recall/count/dispense drills; add temperature evidence and approved reorder thresholds; provision and accept MedSource/UPS credentials, webhooks, shipment exceptions and daily reconciliation. |
